...
analyst_data = pd.read_csv('analyst_ratings.csv')
news_data = pd.read_csv('news_ratings.csv')
price_data = pd.read_csv('results.csv')
...
merged_data[['Ticker', 'final_prediction', 'prediction_confidence']].to_csv('final_stock_ratings_new.csv', index=False)
...
top_10_best[['Ticker', 'final_prediction', 'prediction_confidence']].to_csv('top_10_best_stocks.csv', index=False)
top_10_worst[['Ticker', 'final_prediction', 'prediction_confidence']].to_csv('top_10_worst_stocks.csv', index=False)